...
function updateResults(){
  ...
  const averageSalaryByRole = formatNumber(Number(getAverageSalaryByRole(role)));
  const averageSalaryByCompany = formatNumber(Number(getAverageSalaryByCompany(company)));
  const salary = formatNumber(Number(getSalaryAtCompany(role, company)));
  const industryAverageSalary = formatNumber(Number(getIndustryAverageSalary()));
